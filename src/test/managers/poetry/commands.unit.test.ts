...
suite('Poetry commands', () => {
    ...
    test('PoetryAddCommand executes without error', async () => {
        const command = new PoetryAddCommand({ pythonExecutable: 'poetry', log: mockLog });
    ...
    test('PoetryRemoveCommand executes without error', async () => {
        const command = new PoetryRemoveCommand({ pythonExecutable: 'poetry', log: mockLog });
    ...
    test('PoetryShowCommand executes without error', async () => {
        ...
        const command = new PoetryShowCommand({ pythonExecutable: 'poetry', log: mockLog });
    ...
    test('PoetryShowTopLevelCommand executes without error', async () => {
        ...
        const command = new PoetryShowTopLevelCommand({ pythonExecutable: 'poetry', log: mockLog });
