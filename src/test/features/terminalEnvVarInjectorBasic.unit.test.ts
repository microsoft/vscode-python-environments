...
suite('TerminalEnvVarInjector - Core Functionality', () => {
    ...
    suite('applyEnvVarChanges', () => {
        ...
        test('should update existing variables', () => {
            ...
            injector['applyEnvVarChanges'](mockScopedCollection, initialVars, '/test/workspace');
            ...
            // Run
            injector['applyEnvVarChanges'](mockScopedCollection, updatedVars, '/test/workspace');
        ...
        test('should delete variables with empty values', () => {
            ...
            // Run
            injector['applyEnvVarChanges'](mockScopedCollection, envVars, '/test/workspace');
        ...
        test('should handle first-time initialization with no previous keys', () => {
            ...
            injector['applyEnvVarChanges'](mockScopedCollection, envVars, '/new/workspace');
        ...
        test('should update tracking map correctly', () => {
            ...
            const trackedVars = injector['trackedEnvVars'].get('/test/workspace');
    ...
    suite('cleanupTrackedVars', () => {
        ...
        test('should delete all tracked variables', () => {
            ...
            // Run - cleanup
            injector['cleanupTrackedVars'](mockScopedCollection, '/test/workspace');
        ...
        test('should handle case when no tracked vars exist (no-op)', () => {
            ...
            injector['cleanupTrackedVars'](mockScopedCollection, '/nonexistent/workspace');
    ...
    suite('clearWorkspaceVariables', () => {
        ...
        test('should only delete tracked variables', () => {
            ...
            injector['applyEnvVarChanges'](mockScopedCollection, envVars, mockWorkspaceFolder.uri.fsPath);
